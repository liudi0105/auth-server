...
public interface DepartmentBusiness {
     ...
     * @throws ManagerException 如果在同一个父部门下存在同名的部门则会抛出异常
     * @throws AuthorizationException 如果没有权限创建部门则会抛出异常
     */
     ...
     * @throws AuthorizationException 如果没有权限删除部门则会抛出异常
     */
     ...
     * @throws AuthorizationException 如果没有该部门的权限会抛出异常
     */
     ...
     * @param description 部门描述信息
     * @return Department 部门树信息
     * @throws AuthorizationException 如果没有该部门的修改权限则会抛出异常
     */
     ...
     * @return Department 部门树信息
     * @throws AuthorizationException 如果没有该部门的移动权限以及新父部门的移入权限则会抛出异常
     * @throws ManagerException 如果移动的是根节点则会抛出异常
     */
     ...
     * @throws ManagerException 如果已经创建公司信息则会报错，公司信息应该只有一条
     * @throws AuthorizationException 如果没有创建公司信息的权限
     */
     ...
     * @param description 公司描述信息
     * @return CompanyInfo 公司信息
     * @throws AuthorizationException 如果没有修改公司信息的权限
     */
     ...
     * 用于删除公司信息
     * @return 删除公司信息
     * @throws AuthorizationException 如果没有删除公司信息的权限
     */
